...
export const Survey = (props) => {
    ...
    const [sauceBarbecue, setSauceBarbecue] = useState((Items["barbecue"]*100)/Json["total"]);
    const [sauceBearnaise, setSauceBearnaise] = useState((Items["bearnaise"]*100)/Json["total"]);
    ...
    return (
        <form action="survey.php" method="get">
            <div>  
                ...
                <label htmlFor="barbecue">Team barbecue</label>
            ...
            <div>
                ...
                <input type="radio" value="1" id="bearnaise" name={Name} onChange={(event) => handleChange(event)}/>
                 ...
                 <label htmlFor="bearnaise">Team béarnaise</label>
