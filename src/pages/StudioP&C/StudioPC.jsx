            ...
            <main className="main-container">
                <article className="description otherPages">
                    ...
                    <div className="figure-container">
                        <figure>
                            <img src="/pictures/mo.jpg" alt="photo de Morgane" loading="lazy" />
                            <figcaption>Morgane</figcaption>
                        </figure>
                        <figure>
                            <img src="/pictures/lau.jpg" alt="photo de Laurine" loading="lazy" />
                            <figcaption>Laurine</figcaption>
                        </figure>
                        <figure>
                            <img src="/pictures/ax.jpg" alt="photo de Axel" loading="lazy" />
